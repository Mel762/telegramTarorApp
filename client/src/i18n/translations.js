export const translations = {
    en: {
        ...
        dailyReading: "Automatic Card of the Day",
        autoReading: "Send card and interpretation automatically instead of a reminder",
    ...
    ru: {
        ...
        dailyReading: "Автоматическая Карта дня",
        autoReading: "Присылать карту и толкование сразу вместо напоминания",
    ...
    uk: {
        ...
        dailyReading: "Автоматична Карта дня",
        autoReading: "Надсилати карту та тлумачення відразу замість нагадування",
